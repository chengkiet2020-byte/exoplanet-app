...
if page == "Home":
    ...
    st.markdown(
        ...
        <br>
        <br> <span style="color: yellow !important; font-weight: bold;">Novice Mode</span> 🟢 : For beginners, explore planets by entering basic parameters. (Default dataset: 🔗 <a href="https://exoplanetarchive.ipac.caltech.edu/cgi-bin/TblView/nph-tblView?app=ExoTbls&config=cumulative">NASA Kepler Objects of Interest(KOI)</a>)
        <br>
        <br> <span style="color: green !important; font-weight: bold;">Researcher Mode</span> 🔬 : For advanced users, upload datasets, train models, and analyze results. 
